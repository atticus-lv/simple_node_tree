...
class SP_OT_GroupNodes(bpy.types.Operator):
    bl_idname = "sp.group_nodes"
    bl_label = "Group nodes"

    @classmethod
    def poll(cls, context):
        return context.space_data.type == "NODE_EDITOR" and context.space_data.tree_type in {'SimpleNodeTree',
                                                                                             'SimpleNodeTreeGroup'}
    ...
    def execute(self, context):
        ...
        try:
            ...
            node_group = bpy.data.node_groups.new("Simple Group", "SimpleNodeTreeGroup")
            ...
            group_node = node_tree.nodes.new("SimpleNodeGroup")
...
def register():
    bpy.utils.register_class(SP_OT_GroupNodes)
    bpy.utils.register_class(SP_OP_EditGroup)


def unregister():
    bpy.utils.unregister_class(SP_OT_GroupNodes)
    bpy.utils.unregister_class(SP_OP_EditGroup)
