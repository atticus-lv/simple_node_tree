...
class SimpleNodeTree(NodeTreeBase):
    bl_idname = 'SimpleNodeTree'
    bl_label = 'Simple Editor'
    bl_icon = 'ADD'


class SimpleNodeTreeGroup(NodeTreeBase):
    bl_idname = 'SimpleNodeTreeGroup'
    bl_label = "Simple Node (groups)"
    bl_icon = 'NODETREE'
...
def register():
    bpy.utils.register_class(SimpleNodeTree)
    bpy.utils.register_class(SimpleNodeTreeGroup)


def unregister():
    bpy.utils.unregister_class(SimpleNodeTree)
    bpy.utils.unregister_class(SimpleNodeTreeGroup)
